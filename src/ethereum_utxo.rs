...
pub mod ethereum_utxo {
    ...
    impl<M: ::ethers::providers::Middleware> EthereumUTXO<M> {
        ...
        ///Calls the contract's `MAX_UTXOS` (0x1103d1f6) function
        pub fn max_utxos(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ::ethers::core::types::U256> {
            self.0
                .method_hash([17, 3, 209, 246], ())
    ...
    ///Container type for all input parameters for the `MAX_UTXOS` function with signature `MAX_UTXOS()` and selector `0x1103d1f6`
    #[derive(
        Clone,
    ...
    #[ethcall(name = "MAX_UTXOS", abi = "MAX_UTXOS()")]
    pub struct MaxUtxosCall;
    ...
    impl ::ethers::core::abi::AbiDecode for EthereumUTXOCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded)
                = <MaxUtxosCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MaxUtxos(decoded));
            }
            if let Ok(decoded)
    ...
    impl ::core::fmt::Display for EthereumUTXOCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::MaxUtxos(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<MaxUtxosCall> for EthereumUTXOCalls {
        fn from(value: MaxUtxosCall) -> Self {
            Self::MaxUtxos(value)
        }
    }
    ...
    ///Container type for all return fields from the `MAX_UTXOS` function with signature `MAX_UTXOS()` and selector `0x1103d1f6`
    #[derive(
        Clone,
    ...
    pub struct MaxUtxosReturn(pub ::ethers::core::types::U256);
