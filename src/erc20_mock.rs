...
pub mod erc20_mock {
    ...
    impl<M> ::core::fmt::Debug for ERC20Mock<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC20Mock)).field(&self.address()).finish()
        }
    }
